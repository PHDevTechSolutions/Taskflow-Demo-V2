...
/** Extract YYYY-MM-DD from a record's date_created field. */
...
export const FBTable: React.FC<FBProps> = ({
  ...
  const filtered = useMemo(() => {
    ...
    // Compute once — plain "YYYY-MM-DD" strings or null
    const fromStr = toDateStr(dateCreatedFilterRange?.from);
    const toStr = toDateStr(dateCreatedFilterRange?.to);
    ...
    return activities
      ...
      .filter((i) => {
        ...
        // Pure string comparison — "2025-03-16" >= "2025-03-16" is true
