...
export const CSRTable: React.FC<CSRProps> = ({
  ...
  // Since companies are removed, mergedActivities is now just activities sorted by date_updated or date_created
  ...
  // Filter logic (unchanged except companies removed)
  const filteredActivities = useMemo(() => {
    ...
    return mergedActivities
      ...
      .filter((item) => {
        ...
        const updatedDate = item.date_created ? new Date(item.date_created) : new Date(item.date_created);
  ...
  // Count unique ticket_reference_number (non-null)
