...
export const OutboundTable: React.FC<OutboundTableProps> = ({
  ...
  }, [outboundActivities, searchTerm, filterCallStatus, filterStatus, selectedAgent, dateCreatedFilterRange, agentMap]);

  /* Reset page on filter change */
  useEffect(() => { setPage(1); }, [searchTerm, filterCallStatus, filterStatus, selectedAgent, dateCreatedFilterRange]);
